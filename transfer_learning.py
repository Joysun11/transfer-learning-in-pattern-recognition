...
MODEL_DIR = 'C:/Users/heng/Desktop/python_work/Tensorflow&Google/inception_dec_2015'
MODEL_FILE = 'tensorflow_inception_graph.pb'
CACHE_DIR = 'C:/Users/heng/Desktop/python_work/Tensorflow&Google//bottleneck'
INPUT_DATA = 'C:/Users/heng/Desktop/python_work/Tensorflow&Google//flower_photos'
...
def get_or_creat_bottleneck(sess,image_lists,label_name,index,category,
...
def get_random_cached_bottlenecks(sess,n_classes,image_lists,how_many,
	...
	for _ in range(how_many):
		...
		bottleneck = get_or_creat_bottleneck(sess,image_lists,label_name,
...
def get_test_bottlenecks(sess,image_lists,n_classes,jpeg_data_tensor,
	...
	for label_index,label_name in enumerate(image_lists[label_name][category]):
		bottleneck = get_or_creat_bottleneck(sess,image_lists,label_name,
			image_index,category,jpeg_data_tensor,bottleneck_tensor)
		ground_truth = np.zeros(n_classes,dtype=np.float32)
...
def main():
	...
	with tf.name_scope('final_training_ops'):
		weights = tf.Variable(tf.truncated_normal([BOTTLENECK_TENSOR_SIZE,
		...
		for i in range(STEPS):
			...
			if i % 100 == 0 or i+1 == STEPS:
				...
				validation_accuracy = sess.run(evaluation_step,feed_dict={
					bottleneck_input:validation_bottlenecks,ground_truth_input:
